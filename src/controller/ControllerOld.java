...
public class ControllerOld extends HttpServlet {
    ...
    private void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (command) {
            case "Overview":
                ...
                break;
            case "AddCountry":
                destination = addCountry(request, response);
    ...
    private String addCountry(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
